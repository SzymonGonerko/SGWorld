  ...
  return (
    <group scale={[0.701, 0.701, 0.701]} ref={group} {...props} dispose={null}>
      <group scale={[1, 0.82, 1]}>
        ...
        <skinnedMesh geometry={nodes.Object_6.geometry} material={materials.Wolf3D_Outfit_Top} skeleton={nodes.Object_6.skeleton} />
        <skinnedMesh geometry={nodes.Object_6_1.geometry} material={materials.Wolf3D_Body} skeleton={nodes.Object_6_1.skeleton} />
        <skinnedMesh geometry={nodes.Object_6_2.geometry} material={materials['03_-_Default']} skeleton={nodes.Object_6_2.skeleton} />
      </group>
